...
The CEO notes contradict themselves on purpose. Each contradiction, what we decided, and why. Moved from the README. Rows are in [`AMBIGUITY-REGISTER.md`](../AMBIGUITY-REGISTER.md).
